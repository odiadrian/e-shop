    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(assets/img6.jpg);">
                </div>
                    ...
                    <div class="p-3">
                        ...
                        <form method="POST" action="{{ route('login.custom') }}">
                            ...
                            <div class="row">
                                ...
                                Belum punya akun? <a href="{{ route ('register') }}" class="text-danger">Registrasi</a>
                                </div>
                            </div>
                        </form>
                    </div>
